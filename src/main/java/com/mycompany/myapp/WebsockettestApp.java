...
public class WebsockettestApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(WebsockettestApp.class);

    private final Environment env;

    public WebsockettestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes websockettest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(WebsockettestApp.class);
